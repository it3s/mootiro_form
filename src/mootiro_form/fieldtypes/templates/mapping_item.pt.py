...
def bind():
    ...
    _attrs_67903824 = _loads('(dp1\nVclass\np2\nVreq\np3\nsVid\np4\nVreq-${field.oid}\np5\ns.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_67842000 = _loads('(dp1\nVid\np2\nVitem-${field.oid}\np3\nsVtitle\np4\nV${field.description}\np5\ns.')
    _attrs_67903696 = _loads('(dp1\nVfor\np2\nV${field.oid}\np3\nsVtitle\np4\nV${field.description}\np5\nsVclass\np6\nVdesc\np7\ns.')
    _attrs_67903888 = _loads('(dp1\nVclass\np2\nV${field.widget.error_class}\np3\ns.')
...
__filename__ = u'/home/walrus/FormCreator/src/mootiro_form/fieldtypes/templates/mapping_item.pt'
