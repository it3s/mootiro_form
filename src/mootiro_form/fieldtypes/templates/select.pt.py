...
def bind():
    ...
    _attrs_64821264 = _loads('(dp1\nVname\np2\nV${field.name}\np3\nsVid\np4\nV${field.oid}\np5\ns.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_64821456 = _loads('(dp1\nVvalue\np2\nV${value}\np3\ns.')
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
...
__filename__ = u'/home/walrus/FormCreator/src/mootiro_form/fieldtypes/templates/select.pt'
