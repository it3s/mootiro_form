...
def bind():
    ...
    def render(econtext, rcontext=None):
        ...
        if ((_tmp1 is not None) and (_tmp1 is not False)):
            ...
            _write(((' name="' + _tmp1) + '"'))
        'field.widget.rows'
        _tmp1 = _lookup_attr(_lookup_attr(econtext['field'], 'widget'), 'rows')
        if (_tmp1 is _default):
            _tmp1 = None
        if ((_tmp1 is not None) and (_tmp1 is not False)):
            if (_tmp1.__class__ not in (str, unicode, int, float, )):
            ...
            _write(((' rows="' + _tmp1) + '"'))
        'field.widget.cols'
        _tmp1 = _lookup_attr(_lookup_attr(econtext['field'], 'widget'), 'cols')
        if (_tmp1 is _default):
            _tmp1 = None
        if ((_tmp1 is not None) and (_tmp1 is not False)):
            if (_tmp1.__class__ not in (str, unicode, int, float, )):
...
__filename__ = u'/home/walrus/FormCreator/src/mootiro_form/fieldtypes/templates/textarea.pt'
