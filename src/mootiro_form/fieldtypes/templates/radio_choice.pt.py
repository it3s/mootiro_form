...
def bind():
    ...
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_54474896 = _loads('(dp1\nVtype\np2\nVhidden\np3\nsVname\np4\nV__end__\np5\ns.')
    _attrs_54475344 = _loads('(dp1\nVfor\np2\nV${field.oid}-${repeat.choice.index}\np3\ns.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_54474512 = _loads('(dp1\nVclass\np2\nVdeformSet\np3\ns.')
    _attrs_54475024 = _loads('(dp1\nVclass\np2\nVdeformSet-item\np3\ns.')
    _attrs_54474640 = _loads('(dp1\nVname\np2\nV__start__\np3\nsVtype\np4\nVhidden\np5\nsVvalue\np6\nV${field.name}:rename\np7\ns.')
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _attrs_54475216 = _loads('(dp1\nVname\np2\nV${field.oid}\np3\nsVvalue\np4\nV${value}\np5\nsVtype\np6\nVradio\np7\nsVid\np8\nV${field.oid}-${repeat.choice.index}\np9\ns.')
    def render(econtext, rcontext=None):
        ...
        u'None'
        _domain = None
        attrs = _attrs_54474512
        _write(u'<ul class="deformSet"> \n    ')
        attrs = _attrs_54474640
        ...
        for choice in _tmp1:
            ...
            (value, title, ) = choice
            _write(u'')
            attrs = _attrs_54475024
            _write(u'<li class="deformSet-item">\n          ')
            attrs = _attrs_54475216
            ...
            _write(' ')
        _write(u'\n    ')
        attrs = _attrs_54474896
        _write(u'<input type="hidden" name="__end__" />\n</ul>')
        return _out.getvalue()
    return render

__filename__ = u'/home/walrus/FormCreator/src/mootiro_form/fieldtypes/templates/radio_choice.pt'
