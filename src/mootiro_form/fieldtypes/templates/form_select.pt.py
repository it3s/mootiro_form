...
def bind():
    ...
    _attrs_49863056 = _loads('(dp1\nVname\np2\nV__start__\np3\nsVtype\np4\nVhidden\np5\nsVvalue\np6\nV${field.name}:sequence\np7\ns.')
    _lookup_attr = _loads('cchameleon.core.codegen\nlookup_attr\np1\n.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_49862864 = _loads('(dp1\nVname\np2\nV${field.name}-select\np3\nsVid\np4\nV${field.oid}\np5\ns.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_48718032 = _loads('(dp1\nVvalue\np2\nV${value}\np3\ns.')
    _attrs_48720208 = _loads('(dp1\nVname\np2\nV__end__\np3\nsVtype\np4\nVhidden\np5\nsVvalue\np6\nV${field.name}:sequence\np7\ns.')
    _attrs_49863504 = _loads('(dp1\nVvalue\np2\nV\ns.')
