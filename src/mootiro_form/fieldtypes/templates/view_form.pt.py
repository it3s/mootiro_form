...
def bind():
    ...
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_66828624 = _loads('(dp1\nVclass\np2\nVsection first\np3\ns.')
    _attrs_66829008 = _loads('(dp1\nVclass\np2\nVbuttons\np3\ns.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_66829392 = _loads('(dp1\n.')
    _attrs_66828880 = _loads('(dp1\n.')
    _attrs_66828944 = _loads('(dp1\n.')
    _attrs_66827920 = _loads('(dp1\nVid\np2\nV${field.formid}\np3\nsVaccept-charset\np4\nVutf-8\np5\nsVaction\np6\nV${field.action}\np7\nsVmethod\np8\nV${field.method}\np9\nsVenctype\np10\nVmultipart/form-data\np11\ns.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_66829264 = _loads('(dp1\nVname\np2\nV${button.name}\np3\nsVtype\np4\nV${button.type}\np5\nsVclass\np6\nVbtnText submit\np7\nsVvalue\np8\nV${button.value}\np9\nsVid\np10\nV${field.formid+button.name}\np11\ns.')
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _attrs_66828368 = _loads('(dp1\nVtype\np2\nVhidden\np3\nsVname\np4\nV__formid__\np5\nsVvalue\np6\nV${field.formid}\np7\ns.')
    _marker = _loads("ccopy_reg\n_reconstructor\np1\n(cchameleon.core.i18n\nStringMarker\np2\nc__builtin__\nstr\np3\nS''\ntRp4\n.")
    _attrs_66828432 = _loads('(dp1\n.')
    _attrs_66828304 = _loads('(dp1\nVtype\np2\nVhidden\np3\nsVname\np4\nV_charset_\np5\ns.')
    _attrs_66828240 = _loads('(dp1\nVtype\np2\nVtext/javascript\np3\ns.')
    _attrs_66827792 = _loads('(dp1\nVclass\np2\nVformDescription\np3\ns.')
    _attrs_66828048 = _loads('(dp1\nVclass\np2\nVdeformFormFieldset\np3\ns.')
    _attrs_66828752 = _loads('(dp1\nVclass\np2\nVerrorMsg\np3\ns.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _attrs_66828688 = _loads('(dp1\nVclass\np2\nVerrorMsgLbl\np3\ns.')
    _attrs_66827728 = _loads('(dp1\n.')
    _attrs_66828560 = _loads('(dp1\nVclass\np2\nVerrorLi\np3\ns.')
    def render(econtext, rcontext=None):
        ...
        u'None'
        _domain = None
        attrs = _attrs_66827728
        u'field.form_name'
        _write(u'<h2>')
        _tmp1 = _lookup_attr(econtext['field'], 'form_name')
        _tmp = _tmp1
        ...
        if (_tmp is not None):
            ...
            _write(_tmp)
        _write(u'</h2>    ')
        attrs = _attrs_66827792
        u'field.form_description'
        _write(u'<span class="formDescription">\n        ')
        _tmp1 = _lookup_attr(econtext['field'], 'form_description')
        _tmp = _tmp1
        if (_tmp.__class__ not in (str, unicode, int, float, )):
            try:
                _tmp = _tmp.__html__
        ...
        if _tmp1:
            pass
            attrs = _attrs_66828624
            _write(u'<li class="section first">\n        ')
            attrs = _attrs_66828880
            u'field.title'
            _write(u'<h3>')
            _tmp1 = _lookup_attr(econtext['field'], 'title')
            _tmp = _tmp1
...
__filename__ = u'/home/walrus/FormCreator/src/mootiro_form/fieldtypes/templates/view_form.pt'
