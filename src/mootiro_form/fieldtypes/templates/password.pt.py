...
def bind():
    ...
    def render(econtext, rcontext=None):
        ...
        u'None'
        _domain = None
        attrs = _attrs_62098512
        "join(value('field.name'),)"
        _write(u'<input type="password"')
...
__filename__ = u'/home/walrus/FormCreator/src/mootiro_form/fieldtypes/templates/password.pt'
