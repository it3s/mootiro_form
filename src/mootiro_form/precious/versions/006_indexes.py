...
indexes = [  # "Index" is new in SQLAlchemy 0.7.
    ...
    Index('ix_form_template_system_template_id',
          form_template.c.system_template_id),
    ...
    Index('ix_user_nickname', user_table.c.nickname),
    Index('ix_user_password_hash', user_table.c.password_hash),
    Index('ix_slug_identification_user_slug', slug_id.c.user_slug),
    Index('ix_email_validation_key_key', evk.c.key),
